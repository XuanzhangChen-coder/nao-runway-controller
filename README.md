...
本项目为 2026 年第二十八届[中国机器人及人工智能大赛（CRAIC）](https://www.caairobot.com/post/competition-rules-craic2026/)创新赛参赛项目，由陈炫彰担任主要负责人；指导教师包括[陈启军教授](https://see.tongji.edu.cn/info/1376/10292.htm)等。陈启军是同济大学机器人与人工智能实验室主导师、教授、博士生导师，曾任电子与信息工程学院院长和控制科学与工程系主任，并担任[中国自动化学会理事](https://www.caa.org.cn/article/6/12.html)等职务。本仓库不作未经确认的获奖声明。
...
默认 160 步确定性合成仿真的回归结果为：

| 误差 | 初始值 | 最终值 | 降低比例 |
|---|---:|---:|---:|
| 航向误差 | 11.0° | 2.964° | 73.1% |
| 横向误差 | 260.0 mm | 32.88 mm | 87.4% |

这些数字由仓库内 `simulate_convergence()` 直接计算，只说明闭环控制方向和收敛性，不能替代真机成功率或道路测试。
